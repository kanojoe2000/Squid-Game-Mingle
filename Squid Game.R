...
#
Starting_Conditions<-data.frame((1:1000),round(runif(1000,3,7)),round(2*runif(1000,7,13)),round(3*runif(1000,20,26)),round(4*runif(1000,20,26)),round(5*runif(1000,20,26)),round(6*runif(1000,15,21)),round(7*runif(1000,1,4)))
#
...
#
Call9$FindAs1=
  (Call9$SynthesisDifficulty*((Call9$StragglerGroupsOf7+Call9$StragglerGroupsOf6)/Call9$Denominator))
...
#
Call10$FindAs1=
  (Call10$SynthesisDifficulty*((Call10$StragglerGroupsOf7+Call10$StragglerGroupsOf6)/Call10$Denominator))
Call10$FindAs2=Call10$ChaosFactor*(Call10$StragglerGroupsOf7/Call10$Denominator)+
  (Call10$SynthesisDifficulty*((Call10$StragglerGroupsOf7+Call10$StragglerGroupsOf6)/Call10$Denominator))
Call10$FindAs3=Call10$ChaosFactor*((Call10$StragglerGroupsOf7+Call10$StragglerGroupsOf6)/Call10$Denominator)+
